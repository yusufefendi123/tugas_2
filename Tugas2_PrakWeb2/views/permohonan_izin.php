...
<html lang="en">
  <head>
    ...
    <title>Data Tabel Surat Izin</title>
  ...
  <body>
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="permohonan_izin.php">Permohonan_Izin</a>
            </li>
            <li class="nav-item">
    ...
    <!-- Judul Halaman -->
    <h2 class="text-center my-4">Data Tabel Surat Izin</h2>
